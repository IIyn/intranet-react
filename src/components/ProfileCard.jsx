...
import { calculateAge, getMonthName, getDay } from "../services/utlis";
...
const ProfileCard = (props) => {
  ...
  return (
    <div class="flex flex-col  flex-wrap items-center bg-rose border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-rose-500 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 mb-10 margin-right">
      <img
        style={{ width: "14rem" }}
      ...
      >
        <h1>
          ...
          {calculateAge(randomUser.birthdate)} ans)
        </h1>
        <h2>{randomUser.service}</h2>
        <h2>
          Anniversaire le {getDay(randomUser.birthdate)}{" "}
          {getMonthName(randomUser.birthdate)}
        </h2>
        <h2>
