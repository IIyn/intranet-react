      ...
      <div className="flex justify-center w-72">
          ...
          >
              ...
              <div className="flex flex-nowrap mb-2">
                  ...
                  <select className="p-2 ml-2 w-2/3 rounded text-white"
                          name="service-select"
                          id=""
              ...
              <div className="flex flex-nowrap mb-2">
                  ...
                  <input className="p-2 ml-2 w-4/5 rounded-md text-white"
                         type="text"
                         name="firstname"
                         id="firstname"
              ...
              <div className="flex flex-nowrap mb-2">
                  ...
                  <input className="p-2 ml-2 w-4/5 rounded text-white"
                         type="text"
                         name="address"
                         id=""
                         value={userInfo.city}
              ...
              {user.isAdmin && (
                  <>
                      <div className="flex flex-nowrap mb-2">
                          ...
                          <input className="p-2 ml-2 w-4/5 text-white"
                              type="checkbox"
                              name="isAdmin"
                              id="isAdmin"
              ...
              <button className="m-3 rounded-lg h-12 font-bold text-white bg-gradient-to-b from-red-400 via-red-500 to-pink-500"
