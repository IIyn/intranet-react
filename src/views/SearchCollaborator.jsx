    ...
    return (
        <div>
            <div className="flex justify-center p-3 my-6">
                <h1 className="p-2 mt-1 text-2xl font-bold">Chercher un collaborateur</h1>
                <div className="search p-2 flex justify-flex-start">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                         stroke="currentColor" className="w-6 h-6 mx-5 mt-2">
                    ...
                    <select className="p-2 rounded-md ml-5"
                            name="job-selector"
                            onChange={(e) => {
